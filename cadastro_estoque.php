...
function cadastrar($json_str){
    ...
    //fim da conexao
    //insercao
    $sql = "INSERT INTO estoque (coditem, codloja, descricao, precocusto, precovenda) VALUES (
        $obj->coditem , $obj->cod_loja , $obj->descricao , $obj->precocusto , $obj->precovenda)";
